...
const WhatsAppButton: React.FC = () => {
  return (
    <motion.a
      href="https://wa.me/8801742141355"
      target="_blank"
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-4 bg-white text-slate-900 px-3 py-1.5 rounded-lg text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-lg">
        Chat with me
